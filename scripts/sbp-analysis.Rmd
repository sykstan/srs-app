...
sbp_ccsdt <- gather(sbp_ccsdt, En, value, CorrEn, Total)            # make super long
sbp_mp2 <- gather(sbp_mp2, En, value, OS:RefEn)
...
mp2_cbs <- gather(sbp_mp2, En, value, OS:RefEn) %>%
    spread(Basis, value) %>%
    data.table()
```
...
### _Any ideas what might be the problem?_